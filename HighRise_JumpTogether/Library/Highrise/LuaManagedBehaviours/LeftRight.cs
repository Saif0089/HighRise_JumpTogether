...
{
    [AddComponentMenu("Lua/Left Right")]
    [LuaBehaviourScript(_luaScriptAssetGuid)]
    public class LeftRight : LuaBehaviourThunk
    {
        const string _luaScriptAssetGuid = "466acf1b0f79aaa48a6ac0b4e1b8165d";
        public override string ScriptGUID => _luaScriptAssetGuid;

        [SerializeField] private UnityEngine.Transform m_point1;
        [SerializeField] private UnityEngine.Transform m_point2;
        [SerializeField] private System.Double m_speed;
        [SerializeField] private System.Boolean m_movingToPoint1;
        ...
        protected override void CopyToProperties()
        {
            ...
            _properties[0] = new SerializedPropertyValue()
            {
                ...
                Value = Internal.LuaGlue.CreatePropertyValue(typeof(UnityEngine.Transform), m_point1)
            };

            _properties[1] = new SerializedPropertyValue()
            {
                Property = _script.GetPropertyAt(1),
                Value = Internal.LuaGlue.CreatePropertyValue(typeof(UnityEngine.Transform), m_point2)
            };

            _properties[2] = new SerializedPropertyValue()
            {
                Property = _script.GetPropertyAt(2),
                Value = Internal.LuaGlue.CreatePropertyValue(typeof(System.Double), m_speed)
            };

            _properties[3] = new SerializedPropertyValue()
            {
                Property = _script.GetPropertyAt(3),
                Value = Internal.LuaGlue.CreatePropertyValue(typeof(System.Boolean), m_movingToPoint1)
            };
        }
